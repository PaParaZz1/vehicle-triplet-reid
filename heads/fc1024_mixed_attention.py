...
def head(endpoints, embedding_dim, is_training):
    ...
    with slim.arg_scope(
        ...
        with slim.arg_scope([slim.batch_norm], **batch_norm_params):
            attention_branch_projection = slim.conv2d(endpoints['resnet_v2_50/block4'], 256, [1, 1], scope='attention_branch_projection')
            ...
            attention_branch_residual = slim.conv2d(attention_branch_conv3 + attention_branch_projection, 2048, [1, 1], scope='attention_branch_residual')
