...
def Iresnet(num_classes, pretrained=False, is_backbone=False, backbone_type=None, **kwargs):
    if backbone_type == None:
        raise BaseException("no concrete backbon type\n")
    elif backbone_type == 'resnet50':
        return resnet50(num_classes=num_classes, pretrained=pretrained, is_backbone=is_backbone)
    else:
