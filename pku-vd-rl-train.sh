...
EXPR_NAME='_rl_MLP_ft_6'
# EXPR_NAME='_rl_MLP_ft_5'
...
# INIT_CHECKPT=./experiments/pku-vd/ckpt_inception_MBA_5b_addition/checkpoint-370000 ; shift
INIT_CHECKPT="./experiments/pku-vd/ckpt_inception_MBA_5b_addition_1.0/checkpoint-240000" ; shift
...
python train_rl_5_branch_addition.py \
